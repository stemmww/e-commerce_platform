...
type OrderServiceClient interface {
	...
	UpdateStatus(ctx context.Context, in *OrderStatusUpdate, opts ...grpc.CallOption) (*OrderResponse, error)
...
func (c *orderServiceClient) UpdateStatus(ctx context.Context, in *OrderStatusUpdate, opts ...grpc.CallOption) (*OrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderResponse)
...
type OrderServiceServer interface {
	...
	UpdateStatus(context.Context, *OrderStatusUpdate) (*OrderResponse, error)
...
func (UnimplementedOrderServiceServer) UpdateStatus(context.Context, *OrderStatusUpdate) (*OrderResponse, error) {
...
func _OrderService_UpdateStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateStatus(ctx, req.(*OrderStatusUpdate))
	}
	return interceptor(ctx, in, info, handler)
}
